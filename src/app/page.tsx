...
const TESTIMONIALS = [
    { initials: 'JA', role: 'Juan Avendaño', company: 'Gerente General – IVAL', quote: 'Es difícil encontrar una empresa que realmente entregue la seguridad de que las cosas se están haciendo bien. Con CAPREX encontramos ese respaldo. Hoy nuestros trabajadores están seguros, y yo también.', img: '/prospectos/caprex/juan.png' },
    ...
    { initials: 'CN', role: 'Carlos Neculman', company: 'Dirección Jurídica Municipalidad Quilicura', quote: 'Trabajar con Carla, fue siempre un agrado y una experiencia enriquecedora, por su profesionalismo, constancia, siempre eficiente y preocupada de los objetivos de la organización.', img: '/prospectos/caprex/carlos.png' },
];
