...
const TESTIMONIALS = [
    ...
    { initials: 'PV', role: 'Pendiente', company: 'Empresa', quote: 'Trabajar con Carla, fue siempre un agrado y una experiencia enriquecedora, por su profesionalismo, constancia, siempre eficiente y preocupada de los objetivos de la organización.', img: '/prospectos/caprex/testi-1.png' },
];
