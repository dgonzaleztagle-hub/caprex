...
const TESTIMONIALS = [
    { initials: 'JA', role: 'Juan Avendaño', company: 'Gerente General – IVAL', quote: 'Es difícil encontrar una empresa que realmente entregue la seguridad de que las cosas se están haciendo bien. Con CAPREX encontramos ese respaldo. Hoy nuestros trabajadores están seguros, y yo también.', img: '/prospectos/caprex/testi_juan_final.png' },
    { initials: 'RV', role: 'Rebeca Vasquez', company: 'Jefe de RRHH – Entre Causas', quote: 'En Entre Causas sabíamos cómo conformar nuestro Comité Paritario, pero no contábamos con el tiempo para hacerlo correctamente. CAPREX se encargó de todo en una jornada, con claridad y respaldo normativo. Hoy tenemos un comité activo y funcionando, con la tranquilidad de que está bien hecho.', img: '/prospectos/caprex/testi_logo_final.png' },
    { initials: 'CN', role: 'Carlos Neculman', company: 'Dirección Jurídica Municipalidad Quilicura', quote: 'Trabajar con Carla, fue siempre un agrado y una experiencia enriquecedora, por su profesionalismo, constancia, siempre eficiente y preocupada de los objetivos de la organización.', img: '/prospectos/caprex/testi_carlos_final.png' },
];
